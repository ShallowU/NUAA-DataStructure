...
AVLTree CreatAVLTree(int n,fstream& file);    //创建具有n的结点的AVL树
...
int main()
{
	...
	cout << "----------------------------------AVL树创建演示-----------------------------------" << endl << endl;
	cout << "开始从AVL.txt中读入数据构造初始AVL树" << endl << endl;
	AVLTree ptr, p;

	fstream file("AVL.txt", ios::in);
	file >> n;
	cout << "AVL树初始元素个数：" << n << endl << endl;
	...
	cout << endl << endl << "-------------------------------AVL树查找演示---------------------------------" << endl << endl;
	...
	while (temp--) {
		...
		if (p != NULL){
			cout << "查找成功！元素 “" << n << "” 在AVL树中" << endl << endl;
		}
		else{
			cout << "查找失败！元素 “" << n << "” 不在AVL树中" << endl << endl;
		}
	}
	
	cout << endl<<"----------------------------------AVL树插入演示-----------------------------------" << endl << endl;
	file >> temp;
	...
	while (temp--) {
		...
		file >> n;
		cout << "尝试插入元素“" << n << "”";
		if (AVLInsert(ptr, n))cout << "插入成功！" << endl;
	...
	cout << endl << endl << "----------------------------------AVL树删除演示-----------------------------------" << endl << endl;
